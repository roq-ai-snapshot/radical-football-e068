...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Game', path: '/games', entity: 'game', service: AccessServiceEnum.PROJECT, icon: FiClock },
  {
    name: 'Player Profile',
  ...
  { name: 'Practice', path: '/practices', entity: 'practice', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
